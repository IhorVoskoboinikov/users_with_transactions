...
@router.post("/transactions", tags=["Transactions"], responses=config.RESPONSES_TRANSACTION)
...
@router.get("/transactions/{transaction_id}", tags=["Transactions"], responses=config.RESPONSES_TRANSACTION)
...
@router.get("/transactions", tags=["Transactions"], responses=config.RESPONSES_TRANSACTION)
...
@router.put("/transactions/{transaction_id}", tags=["Transactions"], responses=config.RESPONSES_TRANSACTION)
...
@router.delete("/transactions/{transaction_id}", tags=["Transactions"], responses=config.RESPONSES_TRANSACTION)
